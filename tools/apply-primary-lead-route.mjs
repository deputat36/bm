...
let catalogValidator = fs.readFileSync("tools/validate-catalog-rule-quiz.mjs", "utf8");
catalogValidator = replaceOnce(
  catalogValidator,
  '  "fields_json: JSON.stringify(data, null, 2)",\n',
  "",
  "catalog legacy email payload check"
);
fs.writeFileSync("tools/validate-catalog-rule-quiz.mjs", catalogValidator);
