...
Завершение source review не является разрешением на индексацию. Все восемь материалов сохраняют:
...
Для семи юридически значимых материалов также сохраняется:
