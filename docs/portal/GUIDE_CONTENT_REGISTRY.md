...
Последние два материала закрывают разные задачи:

- документы продавца — что запросить до сделки;
- виды договоров — какое право и на каком этапе получает покупатель.

Они не являются универсальными юридическими заключениями и не содержат данных конкретных объектов.
