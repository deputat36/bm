...
Последние изменения расширяют единый сценарий короткой консультации с главной на страницы трёх приоритетных объектов. Автоматический валидатор контролирует состав полей, идентификаторы, порядок форм, мобильный приоритет и разметку аналитики.
...
8. Собрать источники по другим новостройкам Борисоглебска.
