...
Source review завершён для всех юридически значимых материалов. Это устраняет только один класс блокеров и не меняет итоговый статус:
...
юридическая проверка 6 материалов
